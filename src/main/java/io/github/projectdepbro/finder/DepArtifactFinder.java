...
public interface DepArtifactFinder {

    boolean existsByComposeId(String group, String artifact);

    Optional<DepArtifact> findByComposeId(String group, String artifact);
